...
@Autonomous(name = "CloseRangeRobot", group = "SA_FTC")
//@Autonomous
public class CloseRangeRobot extends LinearOpMode {
    ...
    public void straight(double speed,
        ...
        if(opModeIsActive()) {
            while ((Math.abs(frontLeftMotor.getCurrentPosition()) < Math.abs(newLeftTarget) + startFrontLeft) && Math.abs(frontRightMotor.getCurrentPosition()) < Math.abs(newRightTarget) + startFrontRight) {
                ...
                telemetry.addData("currently at: ", Math.abs(frontRightMotor.getCurrentPosition()));
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            rightGrip.setPosition(0.2);
            leftGrip.setPosition(0.2);
            //straight(0.4, 134);


            straight(0.4, -59); //TODO: Uncommenct if needed
